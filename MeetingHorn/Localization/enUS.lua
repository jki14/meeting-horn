...
L['SHORT'] = 'Quick search'

L['SHORT: Molten Core'] = 'MC' -- 熔火之心
L['SHORT: Onyxia\'s Lair'] = 'Onyxia' -- 奥妮克希亚的巢穴
L['SHORT: Blackwing Lair'] = 'BWL' -- 黑翼之巢
L['SHORT: Ahn\'Qiraj Temple'] = 'TAQ' -- 安其拉神殿
L['SHORT: Naxxramas'] = 'NAXX' -- 纳克萨玛斯
L['SHORT: Zul\'Gurub'] = 'ZUG' -- 祖尔格拉布
L['SHORT: Ruins of Ahn\'Qiraj'] = 'Ruins' -- 安其拉废墟
L['SHORT: Stratholme'] = 'Stratholme' -- 斯坦索姆
L['SHORT: Scholomance'] = 'Scholomance' -- 通灵学院
L['SHORT: Dire Maul - North'] = 'Dire Maul - North' -- 厄运之槌 - 北
L['SHORT: Dire Maul - West'] = 'Dire Maul - West' -- 厄运之槌 - 西
L['SHORT: Dire Maul - East'] = 'Dire Maul - East' -- 厄运之槌 - 东
L['SHORT: Upper Blackrock Spire'] = 'Upper Blackrock Spire' -- 黑石塔上层
L['SHORT: Lower Blackrock Spire'] = 'Lower Blackrock Spire' -- 黑石塔下层
L['SHORT: Blackrock Depths'] = 'Blackrock Depths' -- 黑石深渊
L['SHORT: The Temple of Atal\'Hakkar'] = 'Atal\'Hakkar' -- 阿塔哈卡神庙
L['SHORT: Maraudon'] = 'Maraudon' -- 玛拉顿
L['SHORT: Zul\'Farrak'] = 'ZUL' -- 祖尔法拉克
L['SHORT: Uldaman'] = 'Uldaman' -- 奥达曼
L['SHORT: Razorfen Downs'] = 'Razorfen Downs' -- 剃刀高地
L['SHORT: Scarlet Monastery - Cathedral'] = 'Cathedral' -- 血色修道院 - 大教堂
L['SHORT: Scarlet Monastery - Armory'] = 'Armory' -- 血色修道院 - 军械库
L['SHORT: Scarlet Monastery - Library'] = 'Library' -- 血色修道院 - 图书馆
L['SHORT: Scarlet Monastery - Graveyard'] = 'Graveyard' -- 血色修道院 - 墓地
L['SHORT: Razorfen Kraul'] = 'Razorfen Kraul' -- 剃刀沼泽
L['SHORT: Gnomeregan'] = 'Gnomeregan' -- 诺莫瑞根
L['SHORT: The Stockade'] = 'Stockade' -- 监狱
L['SHORT: Blackfathom Deeps'] = 'lackfathom Deeps' -- 黑暗深渊
L['SHORT: Shadowfang Keep'] = 'Shadowfang Keep' -- 影牙城堡
L['SHORT: Wailing Caverns'] = 'Wailing Caverns' -- 哀嚎洞穴
L['SHORT: Deadmines'] = 'Deadmines' -- 死亡矿井
L['SHORT: Ragefire Chasm'] = 'Ragefire Chasm' -- 怒焰裂谷
L['SHORT: Alterac Valley'] = 'Alterac Valley' -- 奥特兰克山谷
L['SHORT: Warsong Gulch'] = 'Warsong Gulch' -- 战歌峡谷
L['SHORT: Arathi Basin'] = 'Arathi Basin' -- 阿拉希盆地
L['SHORT: Lord Kazzak'] = 'Kazzak' -- 卡扎克
L['SHORT: Azuregos'] = 'Azuregos' -- 艾索雷葛斯
L['SHORT: Ysondre'] = 'Ysondre' -- 伊森德雷
L['SHORT: Taerar'] = 'Taerar' -- 泰拉尔
L['SHORT: Emeriss'] = 'Emeriss' -- 艾莫莉丝
L['SHORT: Lethon'] = 'Lethon' -- 莱索恩
