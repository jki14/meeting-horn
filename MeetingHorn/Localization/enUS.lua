...
L['查询团长信息'] = '查询团长信息'
L['进入团队后查询'] = '进入团队后查询'
L['|cff808080公会成员：|r当前团队有|cffffd100%s|r名成员与团长相同公会，公会名：|cffffd100%s|r。'] = '|cff808080公会成员：|r当前团队有|cffffd100%s|r名成员与团长相同公会，公会名：|cffffd100%s|r。'
L['|cff808080公会成员：|r团长距离过远，无法获得公会信息，建议进入团队后查看。'] = '|cff808080公会成员：|r团长距离过远，无法获得公会信息，建议进入团队后查看。'
L['恭喜完成BOSS击杀！'] = '恭喜完成BOSS击杀！'
L['给团长评价些有趣的标签吧'] = '给团长评价些有趣的标签吧'
L['请就本次团长|cffffd100%s|r的表现给予评分'] = '请就本次团长|cffffd100%s|r的表现给予评分'
L['感谢您的评价。'] = '感谢您的评价。'
L['星团长（按开团次数获取，仅供参考）'] = '星团长（按开团次数获取，仅供参考）'
